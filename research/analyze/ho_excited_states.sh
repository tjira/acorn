...
$PLOT_LINES ACF_1D.mat --xlabel "Time (a.u)" --ylabel "Autocorrelation Function" --output ACF_1D.png
$PLOT_LINES ACF_2D.mat --xlabel "Time (a.u)" --ylabel "Autocorrelation Function" --output ACF_2D.png

$PLOT_LINES ACF_TRANSFORMED_1D.mat --xlabel "Time (a.u)" --ylabel "Autocorrelation Function" --output ACF_TRANSFORMED_1D.png
$PLOT_LINES ACF_TRANSFORMED_2D.mat --xlabel "Time (a.u)" --ylabel "Autocorrelation Function" --output ACF_TRANSFORMED_2D.png

$PLOT_LINES SPECTRUM_1D.mat --xlim 0 6 --xlabel "Energy (a.u)" --ylabel "Intensity" --output SPECTRUM_1D.png
$PLOT_LINES SPECTRUM_2D.mat --xlim 0 8 --xlabel "Energy (a.u)" --ylabel "Intensity" --output SPECTRUM_2D.png

$PLOT_LINES SPECTRUM_TRANSFORMED_1D.mat --xlim 0 6 --xlabel "Energy (a.u)" --ylabel "Intensity" --output SPECTRUM_TRANSFORMED_1D.png
$PLOT_LINES SPECTRUM_TRANSFORMED_2D.mat --xlim 0 8 --xlabel "Energy (a.u)" --ylabel "Intensity" --output SPECTRUM_TRANSFORMED_2D.png

$PLOT_LINES   WAVEFUNCTION_1D_REAL.mat:0,1 --xlabel "Coordinate (a.u)" --ylabel "Value"                             --animate 2 --output WAVEFUNCTION_1D.gif
$PLOT_HEATMAP WAVEFUNCTION_2D_REAL.mat:0,1 --xlabel "Coordinate (a.u)" --ylabel "Coordinate (a.u)" --transform norm --animate 2 --output WAVEFUNCTION_2D.gif
