...
$PLOT POPULATION_EXACT.mat:1 POPULATION_FSSH.mat:1 POPULATION_MASH_FSSH.mat:1 --legend "S0 (EXACT)" "S0 (FSSH)" "S0 (MA-FSSH)" --xlabel "Time (a.u.)" --ylabel "Population" --output POPULATION_FSSH --png
