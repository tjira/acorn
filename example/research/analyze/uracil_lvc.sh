...
$PLOT POPULATION_FSSH.mat POPULATION_LZSH.mat --legend "D0 (FSSH)" "D1 (FSSH)" "D2 (FSSH)" "D3 (FSSH)" "D0 (LZSH)" "D1 (LZSH)" "D2 (LZSH)" "D3 (LZSH)" --xlabel "Time (a.u.)" --ylabel "Population" --output POPULATION --png --dpi 100
