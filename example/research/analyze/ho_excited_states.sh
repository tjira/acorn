...
montage ACF_1D.png SPECTRUM_1D.png -mode concatenate -tile x1 ACF_SPECTRUM_1D.png
montage ACF_2D.png SPECTRUM_2D.png -mode concatenate -tile x1 ACF_SPECTRUM_2D.png

montage ACF_TRANSFORMED_1D.png SPECTRUM_TRANSFORMED_1D.png -mode concatenate -tile x1 TRANSOFMED_ACF_SPECTRUM_1D.png
montage ACF_TRANSFORMED_2D.png SPECTRUM_TRANSFORMED_2D.png -mode concatenate -tile x1 TRANSOFMED_ACF_SPECTRUM_2D.png
