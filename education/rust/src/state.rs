...
impl State {
    ...
    pub fn hamilton(&self, ksq: &Array<Complex<f64>, Ix1>, u: &Array<f64, Ix1>, ket: &State) -> Complex<f64> {
    ...
    pub fn pot(&self, u: &Array<f64, Ix1>, ket: &State) -> Complex<f64> {
...
impl ops::Mul<Complex<f64>> for State {
    type Output = State;
    fn mul(self, rhs: Complex<f64>) -> State {
        State{data: self.data * rhs, dr: self.dr, m: self.m, d: self.d}
    }
}
