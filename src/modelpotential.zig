...
pub fn dims(potential: []const u8) !u32 {
    ...
    if (std.mem.eql(u8, potential,     "uracil10D_1")) return 10;
...
pub fn eval(comptime T: type, U: *Matrix(T), potential: []const u8, r: Vector(T)) !void {
    ...
    if (std.mem.eql(u8, potential,     "uracil10D_1"))     return uracil10D_1(T, U, r);
...
pub fn states(potential: []const u8) !u32 {
    ...
    if (std.mem.eql(u8, potential,     "uracil10D_1")) return 4;
...
pub fn uracil8D_1(comptime T: type, U: *Matrix(T), r: Vector(T)) !void {
    ...
    const omega   = &[_]T{734.00000, 771.00000, 1193.00000, 1383.00000, 1406.00000,  0.00000,  0.00000,  0.00000};
    ...
    for (0..12) |i| {
        ...
        U.ptr(0, 0).* += 0.5 * omega[i] * r.at(i) * r.at(i) / 8065.54429;
        U.ptr(1, 1).* += 0.5 * omega[i] * r.at(i) * r.at(i) / 8065.54429;
        U.ptr(2, 2).* += 0.5 * omega[i] * r.at(i) * r.at(i) / 8065.54429;
        U.ptr(3, 3).* += 0.5 * omega[i] * r.at(i) * r.at(i) / 8065.54429;
    ...
    for (0..4) |i| for (0..4) |j| {U.ptr(i, j).* /= 27.211324570273;};
}

/// The 10-dimensional uracil model potential energy surface.
pub fn uracil10D_1(comptime T: type, U: *Matrix(T), r: Vector(T)) !void {
    U.fill(0);

    const E = &[_]T{9.42, 10.11, 10.48, 11.08};

    const omega   = &[_]T{ 388.00000, 560.00000, 770.00000, 1193.00000, 1228.00000, 1383.00000, 1406.00000,  0.00000,  0.00000,  0.00000};

    const kappa_0 = &[_]T{   0.04139,  -0.05367,   0.05357,   -0.02203,    0.07472,   -0.12147,   -0.09468,  0.00000,  0.00000,  0.00000};
    const kappa_1 = &[_]T{  -0.02688,  -0.00503,  -0.00503,    0.09074,   -0.00582,    0.05316,    0.04454,  0.00000,  0.00000,  0.00000};
    const kappa_2 = &[_]T{  -0.05853,   0.00775,   0.03697,    0.02748,    0.00889,    0.11233,    0.14539,  0.00000,  0.00000,  0.00000};
    const kappa_3 = &[_]T{   0.00132,  -0.04581,  -0.02130,   -0.04054,   -0.02136,    0.00747,    0.00050,  0.00000,  0.00000,  0.00000};

    const gamma_0 = &[_]T{   0.00383,   0.00000,   0.00000,    0.01938,    0.01590,    0.01489,    0.00970,  0.00000,  0.00000,  0.00000};
    const gamma_1 = &[_]T{  -0.00426,   0.00000,   0.00000,    0.00694,    0.01348,    0.00828,    0.00096,  0.00000,  0.00000,  0.00000};
    const gamma_2 = &[_]T{  -0.00366,   0.00000,   0.00000,   -0.00294,    0.00901,    0.00183,   -0.00114,  0.00000,  0.00000,  0.00000};
    const gamma_3 = &[_]T{  -0.00947,   0.00000,   0.00000,    0.00752,    0.00497,    0.00546,    0.01108,  0.00000,  0.00000,  0.00000};

    const d0_0    = &[_]T{   0.00000,   0.00000,   0.00000,    0.00000,    0.00000,    0.00000,    0.00000, 41.89704,  4.80270, 22.92802};
    const d0_1    = &[_]T{   0.00000,   0.00000,   0.00000,    0.00000,    0.00000,    0.00000,    0.00000, 38.37122, 74.15995, 18.27440};
    const d0_2    = &[_]T{   0.00000,   0.00000,   0.00000,    0.00000,    0.00000,    0.00000,    0.00000, 39.25691, 90.76928,  9.46894};
    const d0_3    = &[_]T{   0.00000,   0.00000,   0.00000,    0.00000,    0.00000,    0.00000,    0.00000, 37.97847, 20.56079, 65.09678};

    const a_0     = &[_]T{   0.00000,   0.00000,   0.00000,    0.00000,    0.00000,    0.00000,    0.00000,  0.04719, -0.13675,  0.07438};
    const a_1     = &[_]T{   0.00000,   0.00000,   0.00000,    0.00000,    0.00000,    0.00000,    0.00000,  0.05231, -0.03064,  0.07911};
    const a_2     = &[_]T{   0.00000,   0.00000,   0.00000,    0.00000,    0.00000,    0.00000,    0.00000,  0.05286, -0.03374,  0.08653};
    const a_3     = &[_]T{   0.00000,   0.00000,   0.00000,    0.00000,    0.00000,    0.00000,    0.00000,  0.05431, -0.08044,  0.03660};

    const q0_0    = &[_]T{   0.00000,   0.00000,   0.00000,    0.00000,    0.00000,    0.00000,    0.00000,  0.81440,  0.02883, -0.32069};
    const q0_1    = &[_]T{   0.00000,   0.00000,   0.00000,    0.00000,    0.00000,    0.00000,    0.00000,  0.37488, -1.34468, -0.01711};
    const q0_2    = &[_]T{   0.00000,   0.00000,   0.00000,    0.00000,    0.00000,    0.00000,    0.00000,  0.14859, -0.29923,  0.37635};
    const q0_3    = &[_]T{   0.00000,   0.00000,   0.00000,    0.00000,    0.00000,    0.00000,    0.00000, -0.18152,  0.38841,  1.66312};

    const e0_0    = &[_]T{   0.00000,   0.00000,   0.00000,    0.00000,    0.00000,    0.00000,    0.00000, -0.06431, -0.00007, -0.01274};
    const e0_1    = &[_]T{   0.00000,   0.00000,   0.00000,    0.00000,    0.00000,    0.00000,    0.00000, -0.01505, -0.12082, -0.00003};
    const e0_2    = &[_]T{   0.00000,   0.00000,   0.00000,    0.00000,    0.00000,    0.00000,    0.00000, -0.00244, -0.00916, -0.01037};
    const e0_3    = &[_]T{   0.00000,   0.00000,   0.00000,    0.00000,    0.00000,    0.00000,    0.00000, -0.00366, -0.02071, -0.25639};

    const k_0     = &[_]T{   0.00000,   0.00000,   0.00000,    0.00000,    0.00000,    0.00000,    0.00000,  0.00000,  0.00000,  0.00000};
    const k_1     = &[_]T{   0.00000,   0.00000,   0.00000,    0.00000,    0.00000,    0.00000,    0.00000,  0.00000,  0.00000,  0.00000};
    const k_2     = &[_]T{   0.00000,   0.00000,   0.00000,    0.00000,    0.00000,    0.00000,    0.00000,  0.00000,  0.00000,  0.00000};
    const k_3     = &[_]T{   0.00000,   0.00000,   0.00000,    0.00000,    0.00000,    0.00000,    0.00000,  0.00000,  0.00000,  0.00000};

    const l_01    = &[_]T{   0.00000,   0.00000,   0.00000,    0.00000,    0.00000,    0.00000,    0.00000,  0.00000,  0.00000,  0.00000};
    const l_12    = &[_]T{   0.00000,   0.00000,   0.00000,    0.00000,    0.00000,    0.00000,    0.00000,  0.00000,  0.00000,  0.00000};
    const l_02    = &[_]T{   0.00000,   0.02141,   0.02082,   -0.03538,   -0.03763,   -0.02049,    0.00000,  0.00000,  0.00114,  0.13035};
    const l_13    = &[_]T{   0.00000,   0.00000,   0.01845,    0.08077,    0.05834,    0.00000,    0.07284, -0.08132,  0.12606,  0.14272};
