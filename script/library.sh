...
rm -rf boost eigen fftw gsl libint openblas && mv boost* boost && mv eigen* eigen && mv fftw* fftw ; mv gsl* gsl ; mv libint* libint ; mv OpenBLAS* openblas
...
rm -rf external && mkdir external && cp -r boost/install/* eigen/install/* fftw/install/* gsl/install/* libint/install/* openblas/install/* external

mv external/include/eigen3/Eigen external/include/eigen3/unsupported external/include && rm -rf boost eigen fftw gsl libint openblas zigcc zigcpp external/include/eigen3
