...
Below are some examples of the quantum mechanical methods implemented in Acorn divided in categories. The plotting commands use the script `lines.py` in the `python` folder. You can use this script to plot the data generated by the program.
