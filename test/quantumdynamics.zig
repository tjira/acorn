...
test "qdyn_real_tripleState1D_1" {
    ...
    P.ptr(0, 0).* =  0.09406137151353; P.ptr(0, 1).* = 0.01173494963316; P.ptr(0, 2).* = -0.00173372711837;
    P.ptr(1, 0).* =  0.01173494963316; P.ptr(1, 1).* = 0.09966537676404; P.ptr(1, 2).* =  0.02130317470369;
    P.ptr(2, 0).* = -0.00173372711837; P.ptr(2, 1).* = 0.02130317470369; P.ptr(2, 2).* =  0.80627325172103;
...
test "qdyn_real_tripleState1D_2" {
    ...
    P.ptr(1, 0).* =  0.04371707032137; P.ptr(1, 1).* =  0.04418760360548; P.ptr(1, 2).* = -0.02345042333256;
    P.ptr(2, 0).* = -0.01971557113131; P.ptr(2, 1).* = -0.02345042333256; P.ptr(2, 2).* =  0.15337866242495;
